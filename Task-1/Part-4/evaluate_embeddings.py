...
The code to visualize 10 and 20 words are commented out at the end.
'''
import pickle
import numpy as np
import pandas as pd
...
''' visualizing 20 words
    remaining_words = [w for w in simlex_words if w not in visualize_words_large]
    if len(remaining_words) > 20:
        visualize_words_medium = random.sample(remaining_words, 20)
    else:
        visualize_words_medium = remaining_words

    print(f"\nVisualizing 20 additional random words from SimLex: {', '.join(visualize_words_medium)}")

    tsne_svd_medium = visualize_embeddings(svd_embeddings, visualize_words_medium, word2id, 'tsne', 'SVD Embeddings (20 words)')
    tsne_svd_medium.savefig('plots/svd_tsne_medium.png', dpi=300, bbox_inches='tight')

    tsne_word2vec_medium = visualize_embeddings(word2vec_embeddings, visualize_words_medium, None, 'tsne', 'Word2Vec Embeddings (20 words)')
    tsne_word2vec_medium.savefig('plots/word2vec_tsne_medium.png', dpi=300, bbox_inches='tight')

    tsne_glove_medium = visualize_embeddings(glove_embeddings, visualize_words_medium, None, 'tsne', 'GloVe Embeddings (20 words)')
    tsne_glove_medium.savefig('plots/glove_tsne_medium.png', dpi=300, bbox_inches='tight')
''' 

''' visualizing 10 words
    simlex_words = set()
    for word1, word2 in word_pairs:
        simlex_words.add(word1)
        simlex_words.add(word2)
    
    simlex_words = list(simlex_words)
    if len(simlex_words) > 10:
        visualize_words = random.sample(simlex_words, 10)
    else:
        visualize_words = simlex_words
    
    print(f"\nVisualizing random words from SimLex: {', '.join(visualize_words)}")
    
    # visualize embeddings using PCA
    pca_svd = visualize_embeddings(svd_embeddings, visualize_words, word2id, 'pca', 'SVD Embeddings')
    pca_svd.savefig('plots/svd_pca.png', dpi=300, bbox_inches='tight')
    
    pca_word2vec = visualize_embeddings(word2vec_embeddings, visualize_words, None, 'pca', 'Word2Vec Embeddings')
    pca_word2vec.savefig('plots/word2vec_pca.png', dpi=300, bbox_inches='tight')
    
    pca_glove = visualize_embeddings(glove_embeddings, visualize_words, None, 'pca', 'GloVe Embeddings')
    pca_glove.savefig('plots/glove_pca.png', dpi=300, bbox_inches='tight')
    
    # visualize embeddings using t-SNE
    tsne_svd = visualize_embeddings(svd_embeddings, visualize_words, word2id, 'tsne', 'SVD Embeddings')
    tsne_svd.savefig('plots/svd_tsne.png', dpi=300, bbox_inches='tight')
    
    tsne_word2vec = visualize_embeddings(word2vec_embeddings, visualize_words, None, 'tsne', 'Word2Vec Embeddings')
    tsne_word2vec.savefig('plots/word2vec_tsne.png', dpi=300, bbox_inches='tight')
    
    tsne_glove = visualize_embeddings(glove_embeddings, visualize_words, None, 'tsne', 'GloVe Embeddings')
    tsne_glove.savefig('plots/glove_tsne.png', dpi=300, bbox_inches='tight')
