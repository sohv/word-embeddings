'''
This script evaluates the embeddings generated by the reduced SVD co-occurrence matrix and pre-trained embeddings generated by GloVe and Word2Vec. The metrics used are Spearman's rank correlation coefficient and cosine similarity. Both the embeddings are also extrinsicly evaluated using the defined analogy task.
'''
